 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ScheduleStatus implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScheduleStatus';
    ...
    protected static $setters = [
        ...
        'show_as_tentative_flag' => 'setShowAsTentativeFlag',
        '_info' => 'setInfo'
    ];
    ...
    protected static $getters = [
        ...
        'show_as_tentative_flag' => 'getShowAsTentativeFlag',
        '_info' => 'getInfo'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['show_as_tentative_flag'] = isset($data['show_as_tentative_flag']) ? $data['show_as_tentative_flag'] : null;
    ...
    {
        if ((strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ScheduleStatus., must be smaller than or equal to 30.');
        }
    ...
    /**
     * Gets show_as_tentative_flag
     * @return bool
     */
    public function getShowAsTentativeFlag()
    {
        return $this->container['show_as_tentative_flag'];
    }

    /**
     * Sets show_as_tentative_flag
     * @param bool $show_as_tentative_flag
     * @return $this
     */
    public function setShowAsTentativeFlag($show_as_tentative_flag)
    {
        $this->container['show_as_tentative_flag'] = $show_as_tentative_flag;
